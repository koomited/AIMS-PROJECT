...
for i, ax in enumerate(axs[:num_plots]):
    line1, = ax.plot(lead_time, target_region_atmos_rmses[variables[i]]*100, label="South Africa", c="brown")
    line2, = ax.plot(lead_time, base_region_atmos_rmses[variables[i]]*100, label="USA", c="teal")
    line3, = ax.plot(lead_time, eu_region_atmos_rmses[variables[i]]*100, label="Europe", c="navy")
