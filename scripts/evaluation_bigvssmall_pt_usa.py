...
lat_min ,lat_max , lon_min, lon_max = USA_REGION
...
results = evaluation(small_model, big_model, sliced_era5_USA, sliced_hrest0_USA, device=device)
...
plt.savefig(f"{save_path}/usa_scorecard_bpt_vsspt.pdf", bbox_inches="tight")
plt.savefig(f"{save_path}/usa_scorecard_bpt_vsspt.png", bbox_inches="tight")
plt.savefig(f"{save_path}/usa_scorecard_bpt_vsspt.svg", bbox_inches="tight")
