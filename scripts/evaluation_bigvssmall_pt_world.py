...
full_hrest0_subset = full_hrest0.isel(latitude=slice(0, 720))
full_era5_subset = full_era5.isel(latitude=slice(0, 720))
...
results = evaluation(small_model, big_model, full_era5_subset, full_hrest0_subset, device=device)
...
plt.savefig(f"{save_path}/world_scorecard_bpt_vsspt.pdf", bbox_inches="tight")
plt.savefig(f"{save_path}/world_scorecard_bpt_vsspt.png", bbox_inches="tight")
plt.savefig(f"{save_path}/world_scorecard_bpt_vsspt.svg", bbox_inches="tight")
